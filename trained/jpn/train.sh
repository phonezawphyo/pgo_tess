...
set_unicharset_properties -U unicharset -O unicharset --script_dir=/home/vagrant/shared/langdata
...
tesseract jpn.TakaoGothic.exp0.tif test.TakaoGothic  --tessdata-dir ./ -l jpn && cat test.TakaoGothic.txt
